...
<body>
    <div class="container-box">
        ...
        <!-- Formulário aponta para 'alunos.update' e usa o método 'PUT' -->
        <form action="{{ route('alunos.update', $aluno->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <!-- old() preenche com o valor digitado se a validação falhar, caso contrário usa o valor atual ($aluno->nome) -->
            ...
            <button type="submit" class="btn-submit"><i class="fas fa-save me-2"></i> ATUALIZAR ALUNO</button>
        </form>
    </div>
